...
<table border="1" width="1236" style="margin-bottom:10px;">
    <tr bgcolor="#A9A9A9">
        <th colspan="5" align="left">表4-2 仪器设备</th>
    </tr>
    <tr align="center">
        <td rowspan="2" width="200">指标</td>
        <td colspan="2" width="400">仪器设备（台/套数）</td>
        <td colspan="2" width="400">原值（万元）</td>   
    </tr>
    <tr>
        <td width="100"></td>
        <td align="center">其中：20万元以上仪器设备</td>
        <td width="100"></td>
        <td align="center">其中：20万元以上仪器设备</td>
    </tr>
    <tr>
