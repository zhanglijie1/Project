...
<ul class="layui-nav layui-nav-tree layui-inline" lay-filter="user">
  ...
  <div class="fly-panel fly-panel-user" pad20>
    ...
    <div class="layui-tab-content" style="padding: 20px 0;">
		...
		<form
			action="${pageContext.request.contextPath }/servlet/UpdateServlet?userId=${loginUser.userId}"
			method="post" onsubmit="return check()">

			<div class="layui-form-item">
				<label for="L_nowpass" class="layui-form-label">昵称</label>
				<div class="layui-input-inline">
					<input type="text" id="text" name="nicename"
						autocomplete="off" class="layui-input" value="" >
				</div>
			</div>
			<div class="layui-form-item">
				<label for="L_pass" class="layui-form-label">个性签名</label>
				<div class="layui-input-inline">
					<input type="text" id="usergx" name="usergx"
						autocomplete="off" class="layui-input" value="">
				</div>
